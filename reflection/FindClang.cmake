...
if(LLVM_CONFIG)
    ...
    message(FATAL_ERROR "[ERROR] Can't find llvm-config")
endif()

# Find clang
find_program(CLANG_EXECUTABLE NAMES clang clang-17 clang-16 clang-15 clang-14 clang-13 clang-12 clang-11 clang-10 clang-9 clang-8 PATHS ENV LLVM_PATH)
if(CLANG_EXECUTABLE)
    message(STATUS "[INFO] Found clang: ${CLANG_EXECUTABLE}")
else()
    message(FATAL_ERROR "[ERROR] Can't find clang")
endif()
